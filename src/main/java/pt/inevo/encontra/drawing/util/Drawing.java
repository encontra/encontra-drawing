...
//
//    private static Logger log = Logger.getLogger(Drawing.class.getName());
...
//
//
//    private List <Primitive> primitivesList;	//!< List of all the Primitives
//    private List <Primitive> primitivesListArea; //!< List of all Primitivies ordered by area
//
//    private long id;
//
//    private double height, width; 			//!< height,width of the Drawing
//
//    private String _svgNS; // SVG Namespace URI
//    protected SVGDocument _document; // SVGDocument
//
//    public void setId(Long id) { this.id = id; } //!< Sets this Drawing's id.
//    public Long getId() { return id; }; //!< Returns this Drawing's id.
//
//    /** Default constructor.
//     */
//    public Drawing() {
...
//        createLines();
//        log.info("Creating polylines...");
//        createPolylines();
//        log.info("Creating rects...");
//        //createRects();
//        log.info("... drawing initialized!");
//
//    }
//
//
...
//
//        int size = primitivesList.size();
//
//        Primitive [] primitiveArray = new Primitive[size];
//
//        // Copy pointers to a temporary array
//        for(int i = 0; i < size; i++) {
//            primitiveArray[i] = primitivesList.get(i);
//        }
//
//        while(orderedPrimitives.size() != primitivesList.size()) {
...
//                }
//            }
//            orderedPrimitives.add(primitivesList.get(indexPointer)); // TODO check if it equals push_back();
...
//                }
//            }
//            orderedPrimitives.add(primitivesList.get(indexPointer));
//            primitiveArray[indexPointer] = null;
//        }
//        return orderedPrimitives;
//    }
...
//        }
//
//        prim.setId(primitivesList.size()+1);
//        primitivesList.add(prim); // TODO check it equals - push_back(prim);
//
...
//        }
//
//        if ((i < 0) || (i > primitivesList.size())) {
//            return false;
//        }
//
//        prim.setId(primitivesList.size()+1); //maybe resey the ID's of all the primitives
////	    std::cout << "WARNING: is it bad that ID's aren't ascending?" <<std::endl;
//
//        /* TODO - Does this do the same thing?
//          ListIterator<Primitive> it=primitivesList.listIterator();
//
//          int j=0;
//          for (j=0; j<i; j++) {
//              it.next();
//          }*/
//        primitivesList.add(i ,prim);
//
//        return true;
//    }
//
...
//        if (primitivesList !=null && primitivesList.size()>0) {
//            double ymin = primitivesList.get(0).getYmin();
//            double ymax = primitivesList.get(0).getYmax();
//            for (int i=1; i< primitivesList.size(); i++) {
//                double min = primitivesList.get(i).getYmin();
//                double max = primitivesList.get(i).getYmax();
...
//        if (primitivesList !=null && primitivesList.size()>0) {
//            double xmin = primitivesList.get(0).getXmin();
//            double xmax = primitivesList.get(0).getXmax();
//            for (int i=1; i< primitivesList.size(); i++) {
//                double min = primitivesList.get(i).getXmin();
//                double max = primitivesList.get(i).getXmax();
...
//            double xmin = primitivesList.get(0).getXmin(), min;
//            for (int i=1; i < primitivesList.size(); i++) {
//                    min = primitivesList.get(i).getXmin();
//                    if (min<xmin) xmin=min;
//            }
//            return xmin;
//        }
...
//        if (primitivesList.size() > 0) {
//            double xmax = primitivesList.get(0).getXmax(), max;
//            for (int i=1; i < primitivesList.size(); i++) {
//                    max = primitivesList.get(i).getXmax();
//                    if (max>xmax) xmax=max;
//            }
//            return xmax;
//        }
...
//        if (primitivesList.size() > 0) {
//            double ymin = primitivesList.get(0).getYmin(), min;
//            for (int i=1; i < primitivesList.size(); i++) {
//                    min = primitivesList.get(i).getYmin();
//                    if (min<ymin) ymin=min;
//            }
//            return ymin;
//        }
...
//        if (primitivesList.size() > 0) {
//            double ymax = primitivesList.get(0).getYmax(), max;
//            for (int i=1; i<primitivesList.size(); i++) {
//                    max = primitivesList.get(i).getYmax();
//                    if (max>ymax) ymax=max;
//            }
//            return ymax;
//        }
...
//        ArrayList<Primitive> sortedPrimitives = new ArrayList<Primitive>(primitivesList);
...
//
//        ss.append("Drawing with id: " + id);
//        for (int i = 0; i < primitivesList.size(); i++) {
//            Primitive p = primitivesList.get(i);
//            assert(p!=null);
//            String s = p.toString();
//            ss.append(s);
//        }
...
//        primitivesList = new_list_primitives;
//    }
//
//
